...
from acestep.training_v2.phase_d_timing_v2.checkpointing import save_adapters, load_adapters
...
def test_checkpoint_contains_config(dummy_transformer_stack, config, tmp_path):
    ...
    assert loaded["config"]["schema_version"] == "phase_d_timing_v2_sidecar_v1"
